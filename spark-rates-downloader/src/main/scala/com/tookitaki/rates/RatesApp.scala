...
object RatesApp {
  ...
  implicit val dateTimeEncoder: Encoder[DateTime] = new Encoder[DateTime] {
    override def apply(a: DateTime): Json = Json.fromString(a.formatted("yyyy-MM-dd"))
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    // here I've changed it the data link to be dynamically set for testing
    val dataLink = args.headOption.getOrElse("https://www.coinbase.com/api/v2/prices/BTC-USD/historic?period=year")
